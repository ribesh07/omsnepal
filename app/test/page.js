...
export default function B2BQuickOrder() {
  ...
  const addToCart = () => {
    ...
    alert(`Adding ${itemsToAdd.length} items to cart!\nTotal: Rs. ${getSelectedTotal()}`);
  };
        ...
        <div className="bg-white rounded-lg shadow-sm p-6 mb-6">
          <div className="flex items-center justify-between mb-4">
            <div>
              ...
              <p className="text-gray-600 mt-1">Your frequently purchased items - just update quantity and order</p>
            </div>
            <button
              onClick={addToCart}
              ...
              <div className="flex items-center gap-4">
                ...
                <div className="flex-1">
                  ...
                  <div className="flex items-center gap-4 mt-1">
                    <span className="text-sm text-gray-500">Deli: {product.Deli}</span>
                ...
                <div className="flex items-center gap-2">
                  ...
                  <input
                    ...
                    onChange={(e) => {
                      ...
                      setProducts(products.map(p => 
                        p.id === product.id ? { ...p, quantity: Math.max(1, val) } : p
                      ));
                    }}
